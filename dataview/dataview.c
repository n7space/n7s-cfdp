...
flag cfdpListingFileNameSize_Encode(const cfdpListingFileNameSize* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    BitStream_EncodeConstraintPosWholeNumber(pBitStrm, (*(pVal)), 0, 120);
    } /*COVERAGE_IGNORE*/
...
flag cfdpListingFileNameSize_Decode(cfdpListingFileNameSize* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = BitStream_DecodeConstraintPosWholeNumber(pBitStrm, pVal, 0, 120);
...
flag cfdpListingFileName_Encode(const cfdpListingFileName* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    BitStream_EncodeConstraintWholeNumber(pBitStrm, pVal->nCount, 0, 120);
	    ret = BitStream_EncodeOctetString_no_length(pBitStrm, pVal->arr, pVal->nCount);
    } /*COVERAGE_IGNORE*/
...
flag cfdpListingFileName_Decode(cfdpListingFileName* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = BitStream_DecodeConstraintWholeNumber(pBitStrm, &nCount, 0, 120);
	...
	if (ret && *pErrCode == 0) {
	    ...
	    if (ret) {
	        ...
	        if (DirectoryListingRequest_directory_name_size_is_initialized) {
	            ret = TRUE;
	            Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, DirectoryListingRequest_directory_name_size);
	        } else {
	    ...
	    if (ret) {
	        /*Encode directory_name */
	        ret = BitStream_EncodeOctetString_no_length(pBitStrm, pVal->directory_name.arr, pVal->directory_name.nCount);
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (DirectoryListingRequest_directory_file_name_size_is_initialized) {
	                    ret = TRUE;
	                    Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, DirectoryListingRequest_directory_file_name_size);
	                } else {
	            ...
	            if (ret) {
	                /*Encode directory_file_name */
	                ret = BitStream_EncodeOctetString_no_length(pBitStrm, pVal->directory_file_name.arr, pVal->directory_file_name.nCount);
	            }   /*COVERAGE_IGNORE*/
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag cfdpDirectoryListingRequest_ACN_Decode(cfdpDirectoryListingRequest* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(DirectoryListingRequest_directory_name_size)));
	*pErrCode = ret ? 0 : ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_SIZE;
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        ret = BitStream_DecodeOctetString_no_length(pBitStrm, pVal->directory_name.arr, pVal->directory_name.nCount);
	    ...
	    if (ret) {
	        ...
	        ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(DirectoryListingRequest_directory_file_name_size)));
	        *pErrCode = ret ? 0 : ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_SIZE;
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                ret = BitStream_DecodeOctetString_no_length(pBitStrm, pVal->directory_file_name.arr, pVal->directory_file_name.nCount);
...
flag cfdpDirectoryListingResponse_ACN_Encode(const cfdpDirectoryListingResponse* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    ...
    *pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    ...
	    if (ret) {
	    	Acn_Enc_Int_PositiveInteger_ConstSize(pBitStrm, intVal_pVal_listing_response_code, 1);
	    }
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (DirectoryListingResponse_directory_name_size_is_initialized) {
	                    ret = TRUE;
	                    Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, DirectoryListingResponse_directory_name_size);
	                } else {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        ...
	                        if (DirectoryListingResponse_directory_file_name_size_is_initialized) {
	                            ret = TRUE;
	                            Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, DirectoryListingResponse_directory_file_name_size);
	                        } else {
...
flag cfdpDirectoryListingResponse_ACN_Decode(cfdpDirectoryListingResponse* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode listing_response_code */
	ret = Acn_Dec_Int_PositiveInteger_ConstSize(pBitStrm, (&(intVal_pVal_listing_response_code)), 1);
	*pErrCode = ret ? 0 : ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE;
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(DirectoryListingResponse_directory_name_size)));
	        *pErrCode = ret ? 0 : ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_SIZE;
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(DirectoryListingResponse_directory_file_name_size)));
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (MessageToUserWithHeader_message_type_is_initialized) {
	                ...
	                if (ret) {
	                	Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, intVal_MessageToUserWithHeader_message_type);
	                }
	            } else {
...
flag cfdpMessageToUserWithHeader_ACN_Decode(cfdpMessageToUserWithHeader* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode MessageToUserWithHeader_message_identifier */
	{
		static byte tmp[] = {0x63,0x66,0x64,0x70};
	    flag bDecodingPatternMatches;
		ret = BitStream_ReadBitPattern(pBitStrm, tmp, 32, &bDecodingPatternMatches);
	    ret = ret && bDecodingPatternMatches;
	...
	if (ret) {
	    ...
	    ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(intVal_MessageToUserWithHeader_message_type)));
...
flag cfdpTLV_Decode(cfdpTLV* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode length_value */
	ret = BitStream_DecodeConstraintWholeNumber(pBitStrm, &cfdpTLV_length_value_index_tmp, 0, 0);
	...
	if (ret && *pErrCode == 0) {
	    ...
	    if (ret) {
	        ...
	        if (TLV_tag_is_initialized) {
	            ret = TRUE;
	            Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, TLV_tag);
	        } else {
	        ...
	        case TLV_length_value_message_to_user_PRESENT:
	        	        ...
	        	        if (ret) {
	        	            ...
	        	            if (ret) {
	        	                ...
	        	                if (TLV_length_value_message_to_user_value_message_type_is_initialized) {
	        	                    ...
	        	                    if (ret) {
	        	                    	Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, intVal_TLV_length_value_message_to_user_value_message_type);
	        	                    }
	        	                } else {
	        	...
	        	if (ret) {
	        	    ...
	        	    if (TLV_length_value_message_to_user_length_is_initialized) {
	        	        ret = TRUE;
	        	        Acn_Enc_Int_PositiveInteger_ConstSize_8(pBitStrm, TLV_length_value_message_to_user_length);
	        	    } else {
	        	...
	        	if (ret) {
	        	    /*Encode value */
	        	    ret = BitStream_EncodeOctetString_no_length(pBitStrm, arr, (int)TLV_length_value_message_to_user_length);
	        	}   /*COVERAGE_IGNORE*/
	        	break;
	        default:
...
flag cfdpTLV_ACN_Decode(cfdpTLV* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode TLV_tag */
	ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(TLV_tag)));
	...
	if (ret) {
	    ...
	    *pErrCode = 0;
	    if ((TLV_tag == 2)) {
	        ...
	        ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(TLV_length_value_message_to_user_length)));
	        ...
	        if (ret) {
	            ...
	            /*open new scope to declare some variables*/
	            {
	            	...
	            	*pErrCode = ret ? 0 : ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2;
	            	if (ret) {
	            		/*decode to the temporary bitstream buffer */
	            		ret = BitStream_DecodeOctetString_no_length(pBitStrm, arr, (int)TLV_length_value_message_to_user_length);
	            		*pErrCode = ret ? 0 : ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2;
	            		if (ret) {
	                        pBitStrm = &bitStrm;
	                        ...
	                        if (ret) {
	                            ...
	                            ret = Acn_Dec_Int_PositiveInteger_ConstSize_8(pBitStrm, (&(intVal_TLV_length_value_message_to_user_value_message_type)));

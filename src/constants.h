...
#define CFDP_ALIGN(size) (((size + (CFDP_ALIGNMENT_SIZE - 1)) / CFDP_ALIGNMENT_SIZE) * CFDP_ALIGNMENT_SIZE)

#define CFDP_BUFFER_SIZE(item_size) (CFDP_ALIGN(item_size))

#define VIRTUAL_SOURCE_FILE_BUFFER_SIZE CFDP_BUFFER_SIZE(1024)
#define FILE_SEGMENT_BUFFER_SIZE CFDP_BUFFER_SIZE(cfdpFileData_REQUIRED_BYTES_FOR_ACN_ENCODING - 2)
...
#define FILE_SEGMENT_BUFFER_OFFSET (VIRTUAL_SOURCE_FILE_BUFFER_OFFSET )
#define PDU_BUFFER_OFFSET (VIRTUAL_SOURCE_FILE_BUFFER_OFFSET + FILE_SEGMENT_BUFFER_OFFSET)
#define MODIFIED_PDU_BUFFER_OFFSET (VIRTUAL_SOURCE_FILE_BUFFER_OFFSET + FILE_SEGMENT_BUFFER_OFFSET + PDU_BUFFER_OFFSET)

#define CFDP_DATA_BUFFER(name) uint8_t name[VIRTUAL_SOURCE_FILE_BUFFER_SIZE + FILE_SEGMENT_BUFFER_SIZE + 2 * PDU_BUFFER_SIZE] CFDP_ALIGNED
